...
export default function OurCultureCarousel({
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-9 md:grid md:grid-cols-12 w-full h-[29.7rem]">
        {/* Button */}
        <div className="col-span-1 md:col-span-3 h-[28.2rem] md:flex md:flex-col py-2 mb-2 border-r-2 border-gray-300  ">
          <div className="grid grid-rows-6 md:flex md:flex-col text-sm rounded-xl bg-blue-700 w-[2.2rem] pt-1 pb-1 md:w-[9rem] md:p-3 pr-4 md:gap-5 lg:w-[13rem] lg:h-[25rem] lg:p-6 m-2">
        ...
        {/* Carousel Part */}
        <div className="col-span-8 md:col-span-9 flex flex-row">
                  ...
                  <div className=" p-3 md:h-1/2 sm:p-7 md:p-5 lg:w-2/3 lg:p-4 lg:pt-5 xl:p-7">
                    ...
                    <div className="flex flex-row md:gap-3">
                      ...
                      >
                        ...
                        <span className="ml-2 pb-2 text-orange-600 text-2xl md:text-4xl transition-transform duration-300 hover:translate-x-2">
                          →
                        </span>
                      </Link>
                    </div>
                  </div>
                  <div className=" relative pl-2 pr-2 pt-2 pb-2 sm:-top-6 md:-top-9 md:pl-5 md:pr-5 lg:-top-3">
                    <motion.img
                      key={activeTopic.image}
                      src={activeTopic.image}
                      alt={activeTopic.title}
                      className="rounded-md shadow-lg w-[26rem] h-[14rem] sm:w-[27rem] sm:h-[15rem] md:w-[28rem] md:h-[17rem] lg:w-[28rem] lg:h-[13rem] xl:w-[50rem] xl:h-[18rem] object-cover"
